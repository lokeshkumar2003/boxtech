    ...
    <div className="grid grid-cols-2 w-[full] h-[90vh] sm:h-auto sm:flex sm:flex-col">
      ...
      <div className="flex justify-center items-center">
        <div id="desc-card" className="w-[550px]">
            <h1 className="w-[100%] text-[32px] sm:text-[28px]">Built for <span style={{'color':'#ffbe23'}}>Businesses</span>, by <span style={{'color':'#ffbe23'}}>Creatives.</span></h1>
            <div className="w-[60%] my-[18px] sm:w-[80%]" >
