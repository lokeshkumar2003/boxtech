...
const Pricing = () => {
  return (
    <div className='h-[90vh] w-full grid grid-cols-2 bg-[#F6F5F5]'>
        <div className='flex flex-col justify-center items-center'>
            <div id='con1'>
                <h1 className='my-[18px] w-[70%]'>Explore our <span style={{'color':'#FFBF23'}}>Pricing</span> Options</h1>
                <p className='w-[80%]'>Simple plans that grow with your business. No contracts. No Setup fees.</p>
                <a href='/'>
                    <button className='bg-black p-[10px] my-[20px] text-white rounded-[5px] tracking-[1px]'>
                        See More
                    </button>
                </a>
            </div>
            ...
            <div className="py-[18%] px-[10%]">
                ...
                <div className="rounded-[10px] border-black border-[3px] h-[360px] w-[330px]">
                    <div className="bg-[#FFBF23] w-[100%] p-[15px] border-b-[3px] border-black">
                        ...
                        <a href="/"><button className="bg-black p-[10px] my-[20px] text-white rounded-[5px] tracking-[1px] block mx-auto">
                            Get Started
                        </button></a>
                    </div>
