  ...
  return (
    <div className='h-[90vh] w-full grid grid-cols-2 bg-[#F6F5F5] sm:h-auto sm:flex sm:flex-col'>
        <div className='flex flex-col justify-center items-center'>
            <div id='con1' className='sm:p-[18px]'>
        ...
        <div>
            <div className="py-[18%] px-[10%] sm:py-[12%] sm:px-[6%]">
                <div className="my-[15px] sm:m-[10px]" >
                    <h3 id="pricing" className="w-[60%] text-[30px] sm:text-[28px] tracking-[2px] font-bold sm:w-[90%] my-[12px]">Choose your pricing plan</h3>
                </div>
